...
import { CalendarClock, Clock3, Heart, UserCircle2, Wrench } from 'lucide-react';
    ...
    return (
        <div className="mx-auto max-w-6xl px-4 py-10">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <Link to="/student/profile"><Button fullWidth variant="outline"><UserCircle2 className="h-4 w-4 mr-2" />My Profile</Button></Link>
