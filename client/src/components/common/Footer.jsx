    ...
    <footer className="mt-auto border-t border-primary-100 bg-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* For Owners */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-800">For Owners</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/owner-guide" className="text-gray-600 hover:text-primary-600 transition-colors">
                  Owner Guide
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            © 2026 UNIHOME. All rights reserved.
          </p>
